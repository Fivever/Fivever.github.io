...
- 加密过程
  ...
  <img src="https://latex.codecogs.com/png.latex? L_{i}=R_{i-1}和R_i=L_{i-1}\bigoplus f(R_{i-1},K_i)">
...
- 解密过程
  ...
  2. <img src="https://latex.codecogs.com/png.latex? [R_n][L_n]=[L_{n-1}][R_{n-1}\bigoplus f(L_{n-1},K_n)]\\=[R_{n-2}][L_{n-2}\bigoplus f(R_{n-2},K_{n-1})\bigoplus f(L_{n-1},K_n)]=[R_{n-2}][L_{n-2}]">
