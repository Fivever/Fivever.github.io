...
- 定义
    ...
    整数序列a的最大公因数可以记为<img src="http://chart.googleapis.com/chart?cht=tx&chl= {\displaystyle (a_{1},a_{2},\dots ,a_{n})} {\displaystyle (a_{1},a_{2},\dots ,a_{n})}或 {\displaystyle \gcd(a_{1},a_{2},\dots ,a_{n})} {\displaystyle \gcd(a_{1},a_{2},\dots ,a_{n})}">
