...
现在假设我们有一个数据集<img src="http://chart.googleapis.com/chart?cht=tx&chl= D={x_1,\ x_2,\ ...,\ x_N}">独立同分布，那么该数据集的似然函数是：<img src="http://chart.googleapis.com/chart?cht=tx&chl= \prod_{n=1}^Np(x_n,\mu)=\prod_{n=1}^N\mu^{x_n}(1-\mu)^{1-x_n} ">
