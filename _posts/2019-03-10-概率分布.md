...
R取为以x为中心的D维小方体，定义<img src="https://latex.codecogs.com/png.latex?k(u)=\left\{\begin{matrix}&space;1\&space;\&space;|u_i|\leqslant&space;\frac12\&space;\&space;i=1..D\\&space;0\&space;\&space;\&space;\&space;\&space;\&space;\&space;else\&space;\&space;\&space;\&space;\&space;\&space;\&space;\&space;\&space;\&space;\&space;\&space;\&space;\end{matrix}\right">

所以当边长为h时，<img src="https://latex.codecogs.com/png.latex?k(\frac{x-x_n}n)=\left\{\begin{matrix}&space;1\&space;\&space;\&space;\&space;in\\&space;0\&space;\&space;\&space;out&space;\end{matrix}\right">，所以位于方体内数据点的总数为<img src="https://latex.codecogs.com/png.latex?K=\sum_{n=1}^Nk(\frac{x-x_n}n)">，因为D维边长为h的方体V=h^D，所以核密度估计或Parzen估计为
...
最近邻(k=1)分类器在<img src="https://latex.codecogs.com/png.latex?N->\infty">时，错误率不会超过最优分类器（即用真实概率分布的分类器）可达到的最小错误率的2倍
